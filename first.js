...
function renderFunction(presentClass,totalClass,PercentageText,RequiredText,card) {
...
addButton.addEventListener("click",(e)=>{
   ...
   if(!input.value.trim()){
    ...
    presentButton.addEventListener("click",(e)=>{
        ...
        renderFunction(presentClass,totalClass,PercentageText,RequiredText,card) 
    });
    ...
    subjectCardContainer.append(subjectName,buttonContainer,PercentageText,RequiredText);
